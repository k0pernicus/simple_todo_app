defmodule SimpleTodoApp.TodoControllerTest do
  use SimpleTodoApp.ConnCase

  alias SimpleTodoApp.Todo
  @valid_attrs %{due_date: %{day: 17, hour: 14, min: 0, month: 4, sec: 0, year: 2010}, name: "some content"}
  @invalid_attrs %{}
